...
Once you have the library implemented you can use it\sidenote{really just sorted\_ints and write\_times} to write a \textit{main} procedure that records the running time of all $501$ cases of \textit{std::find} with a vector of integers of size $500$\sidenote{the case analysis of this problem is covered in LN14}. Your times should be written as comma separated values to a file called \textit{labp2.csv}.  
