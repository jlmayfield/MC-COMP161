...
\begin{enumerate}
\item Copy the file \textit{lab2.zip} from \textit{/home/comp161/sp18} to your home directory. Use the command \textit{unzip} to extract the files.\sidenote{use \textit{man unzip} to get the manual for unzip and see if you can figure out how to use it from that}.
