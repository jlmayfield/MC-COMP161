...
\end{abstract}
  ...
  \item In plain English, describe what this loop does. (Hint: Step through it for some small value of $n$ and see exactly what it does for that $n$. Then describe that in more general terms. \textit{Do not translate the code verbatim to English.}).
